export const servicesData = [
    {
        title: "Dépannage Électrique à Nice – Urgences 7j/7",
        slug: "depannage",
        description:
            "Besoin d’un dépannage électrique à Nice ? Court-circuit, panne de courant, disjoncteur qui saute... Notre électricien intervient rapidement, 7j/7, pour sécuriser votre installation et rétablir l’électricité en toute sécurité.",
        keywords:
            "dépannage électrique Nice, électricien urgence Nice, court-circuit, disjoncteur saute, panne électricité",
        image: "/images/depannage-electricien-nice.jpg",
        secondaryImage: "/images/electricien-urgence-nice.webp",
        benefits: [
            "Intervention d'urgence en moins de 30 minutes à Nice",
        ...
        serviceBenefitsDescription1:
            "Notre service de dépannage électrique à Nice est conçu pour répondre rapidement à toute situation d'urgence : panne de courant, court-circuit, disjoncteur qui saute…",
        serviceBenefitsDescription2:
            "Nos électriciens qualifiés se déplacent rapidement partout à Nice, même les week-ends et jours fériés, pour diagnostiquer avec précision la source de la panne et effectuer les réparations nécessaires. Qu’il s’agisse d’un court-circuit, d’un disjoncteur qui saute ou d’une coupure générale, nous intervenons avec tout le matériel adapté pour remettre votre installation en état de fonctionnement dans les plus brefs délais, en assurant votre sécurité et celle de votre logement.",
    },

    {
        title: "Installation Électrique Complète à Nice",
        slug: "installation",
        description:
            "Installation électrique pour maison neuve, rénovation ou local commercial à Nice. Tableaux électriques, prises, éclairages… tout est pris en charge dans le respect des normes NF C 15-100.",
        keywords:
            "installation électrique Nice, électricien logement neuf, tableau électrique, mise en conformité, prises et interrupteurs",
        ...
        serviceBenefitsDescription1:
            "Que ce soit pour un logement neuf, une rénovation ou un local professionnel, nous assurons une installation électrique complète à Nice.",
        serviceBenefitsDescription2:
    ...
    {
        title: "Rénovation Électrique à Nice – Sécurisez Votre Logement",
        slug: "renovation",
        description:
            "Modernisez votre installation électrique à Nice : câblages anciens, prises vétustes, risques de court-circuit… Nous rénovons entièrement votre réseau électrique pour plus de sécurité et de performance.",
        keywords:
            "rénovation électrique Nice, mise aux normes, remplacement câbles, tableau vétuste, sécurité électrique",
        ...
        serviceBenefitsDescription1:
            "Notre service de rénovation électrique à Nice vous permet de moderniser des installations vétustes ou dangereuses.",
        serviceBenefitsDescription2:
    ...
    {
        title: "Inspection & Sécurité Électrique à Nice",
        slug: "inspection",
        description:
            "Contrôle et vérification de votre installation électrique à Nice. Détection de défauts, conformité réglementaire, sécurité des personnes et des biens. Idéal pour vente immobilière ou prévention des risques.",
        keywords:
            "inspection électrique Nice, diagnostic sécurité électricité, conformité installation, contrôle électricien",
        ...
        serviceBenefitsDescription1:
            "Grâce à notre service d’inspection électrique à Nice, vous bénéficiez d’un contrôle rigoureux de votre installation.",
        serviceBenefitsDescription2:
    ...
    {
        title: "Installation d’Éclairage à Nice – Intérieur & Extérieur",
        slug: "eclairage",
        description:
            "Éclairage LED, spots, luminaires de jardin, éclairage de sécurité… Nous installons vos systèmes lumineux à Nice pour valoriser vos espaces tout en réduisant votre consommation énergétique.",
        keywords:
            "installation éclairage Nice, spots LED, luminaires extérieurs, éclairage jardin, électricité décoration",
        ...
        serviceBenefitsDescription1:
            "Nous réalisons l’installation d’éclairages LED, luminaires décoratifs, éclairage extérieur et dispositifs de sécurité à Nice.",
        serviceBenefitsDescription2:
    ...
    {
        title: "Mise aux Normes Électriques à Nice",
        slug: "mise-aux-normes",
        description:
            "Protégez vos proches et vos équipements en mettant votre installation aux normes. Nos électriciens certifiés à Nice assurent la mise en conformité selon la norme NF C 15-100.",
        keywords:
            "mise aux normes électrique Nice, conformité NF C 15-100, électricien certifié, protection électrique",
        ...
        serviceBenefitsDescription1:
            "La mise aux normes électriques est indispensable pour garantir la sécurité des occupants et la conformité de votre logement à Nice.",
        serviceBenefitsDescription2:
