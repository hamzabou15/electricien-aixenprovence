    ...
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-bold text-[#003049] mb-6">
            Solutions Électriques à <span className="text-[#FFD600]">Aix-en-Provence</span>
          </h2>
          ...
          {servicesData.map((service, index) => (
            ...
            >
              ...
              <div className="p-6 bg-white">
                <h3 className="text-xl font-bold text-[#0055AA] group-hover:text-[#003366] transition-colors">
                  {service.title}
                </h3>
                <p className="text-gray-600 mt-2">{service.description}</p>
                <span className="inline-block mt-4 text-[#0055AA] font-medium group-hover:underline">
                  En savoir plus
                </span>
              </div>
            </Link>
