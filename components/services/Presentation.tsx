...
const Presentation = () => {
    return (
        <>
            <Head>
                <title>Électricien à Toulon – Services de diagnostic, installation et dépannage</title>
                <meta
                    name="description"
                    content="Électricien professionnel à Toulon, proposant diagnostics, installations électriques, mise aux normes NF C 15‑100 et dépannage rapide. Devis gratuit."
                />
            </Head>

            <section className="w-full bg-white" id="services-intro-electricien-Toulon">
          ...
          ">
                        <span className="text-[12px] font-semibold text-[#c1121f] uppercase tracking-[7px] max-sm:m-auto">
                            Nos Services
                        </span>
                        <h2 className="text-[30px] text-[#003049] font-bold tracking-[-1.5px] leading-tight mt-3 mb-6 max-sm:text-center ">
                            Diagnostic, installation & dépannage électrique à Toulon
                        </h2>

                        <p className="text-[15px] font-light text-[#2E2937BF] leading-7 text-justify mb-8">
                            En tant qu’électricien local à Toulon, nous intervenons pour :
                        ...
                        <div className="flex flex-col items-start lg:items-start group">
                            <span className="font-semibold text-[#003049] ">Contactez-nous dès maintenant</span>
                            <div className="flex items-center gap-2 mt-4 font-semibold cursor-pointer ">
                                ...
                                <a href="tel:+33756935200" aria-label="Appeler Électricien Toulon">
                                    <span className="text-[18px] font-medium text-[#c1121f] ">+33 7 56 93 52 00</span>
                                </a>
                            </div>
                        </div>
                    </div>
