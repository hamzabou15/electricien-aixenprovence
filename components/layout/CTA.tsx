...
const CTA = () => {
  return (
    <div className="fixed bottom-16 right-8 flex flex-col items-end z-50 space-y-4 max-md:w-full max-md:lef-0 max-md:p-6 max-md:bottom-4">
      {/* Bouton téléphone */}
      <Button
        asChild
        variant="submit"
        size="xlg"
        className="group flex items-center overflow-hidden rounded-md shadow-md bg-gradient-to-r from-[#0055AA] to-[#FFD600] hover:from-[#004080] hover:to-[#e6c200] transition-all duration-300"
      >
        <a
      ...
      <Link href="/contact" passHref className='max-md:w-full'>
        <Button
          ...
          rounded-md shadow-md bg-gradient-to-r from-[#0055AA] to-[#FFD600]
