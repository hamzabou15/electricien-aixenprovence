...
const ContactForm = () => {
    ...
    return (
        <section
            id="contact-electricien-aix-en-provence"
            aria-label="Formulaire de contact pour dépannage électrique à Aix-en-Provence"
            className="w-full bg-white py-20 px-6 md:px-8"
        >
            <div className="max-w-5xl mx-auto">
                {/* En-tête */}
                <div className="text-center mb-12">
                    <span className="inline-block px-4 py-2 bg-[#FFD600] text-[#0055AA] text-sm font-bold rounded-full mb-4">
                        CONTACT RAPIDE
                    </span>
                    ...
                    <p className="text-gray-700 max-w-2xl mx-auto">
                        Intervention 24h/24 et 7j/7 à Aix-en-Provence. Nos électriciens certifiés sont prêts à intervenir
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12 text-center">
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-bold text-[#0055AA]">Téléphone</p>
                        <p className="text-gray-600">04 90 00 00 00</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <FaEnvelope className="text-[#FFD600] text-2xl mb-2" />
                        <p className="font-bold text-[#0055AA]">Email</p>
                        <p className="text-gray-600">contact@electricienaixenprovence-sos.fr</p>
                    </div>
                    <div className="flex flex-col items-center">
                        <FaMapMarkerAlt className="text-[#FFD600] text-2xl mb-2" />
                        <p className="font-bold text-[#0055AA]">Adresse</p>
                        <p className="text-gray-600">Aix-en-Provence & alentours</p>
                    </div>
                </div>
                ...
                {state.succeeded ? (
                    ...
                    <form
                        ...
                        className="bg-[#F5F8FF] p-8 rounded-xl shadow-lg max-w-3xl mx-auto flex flex-col gap-6 text-[#003049]"
                    >
                        <input type="hidden" name="_subject" value="Nouvelle demande – Formulaire Électricien Aix-en-Provence" />
                        ...
                        <div className="flex justify-center mt-4">
                            <Button
                                ...
                                className="min-w-[220px] text-white bg-[#0055AA] hover:bg-[#003E7E]"
                            >
