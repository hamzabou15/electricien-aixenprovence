...
const StatsCard = () => {
    const stats = [
        {
            value: 2500,
            label: 'Interventions réalisées à Aix-en-Provence',
        ...
        {
            value: 30,
            label: 'Minutes de réactivité moyenne sur Aix',
    ...
    return (
        <section
            className='w-full py-16 bg-gradient-to-r from-[#0055AA] to-[#003366] text-white'
            id="chiffres-electricien-aixenprovence"
            aria-label="Statistiques de notre électricien à Aix-en-Provence"
        >
            <div className="max-w-6xl mx-auto px-4 text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                    Notre impact à <span className="text-[#FFD600]">Aix-en-Provence</span>
                </h2>
