...
const ServicesCarousel = () => {
  const services = [
    {
      ...
      image: "/images/depannage-urgence-aixenprovence.webp",
      keywords: ["urgence électricité", "dépannage électrique", "panne courant Aix"]
    },
    {
    ...
    },
    {
      ...
      description: "Modernisation complète de votre installation électrique pour plus de confort et d'efficacité à Aix-en-Provence",
      image: "/images/renovation-electrique-aixenprovence.webp",
      keywords: ["rénovation électrique", "remise à neuf", "électricité neuve"]
    },
    {
      icon: <FaTools className="text-3xl text-[#FFD600]" />,
      title: "Tableau électrique",
      description: "Installation et remplacement de tableau électrique à Aix-en-Provence",
  ...
  return (
    <section 
      ...
      aria-label="Carrousel de nos services d'électricien à Aix-en-Provence"
    >
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#0055AA] mb-6">
            Exemples de nos travaux à <span className="text-[#FFD600]">Aix-en-Provence</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Découvrez nos interventions d&apos;électricien à travers le pays d&apos;Aix
          </p>
        </div>
                ...
                <div className="p-2">
                  <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div className="relative h-60">
                      <Image
                        src={service.image}
                        alt={`Service d'électricien: ${service.title} à Aix-en-Provence`}
                        fill
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center gap-3 mb-4">
                        {service.icon}
                        <h3 className="text-xl font-bold text-[#0055AA]">{service.title}</h3>
                      </div>
