...
const About2 = () => {
  return (
    <section className='bg-white w-full px-4 h-auto'>
      <div className='flex gap-8 py-2 h-full'>
        {/* Image à gauche */}
        <div className='w-[60%] h-full pr-10 mt-20'>
          <Image
            width={1000}
            height={1000}
            alt='Électricien professionnel intervenant à Nice'
            src='/images/Electricien-nice.webp'
            className='w-full object-cover object-top min-h-screen max-h-[900px]'
          />
        </div>

        {/* Texte à droite */}
        <div className='w-[40%] flex flex-col py-2 px-0 gap-8 mt-20'>
          <div className='flex flex-col gap-2'>
            <p className='text-[12px] font-semibold text-[#f25000] uppercase tracking-[7px]'>
              Électricien certifié à Nice
            </p>
            <h3 className='text-[54px] text-[#1b1e3f] m-0 leading-[1.15em] font-bold tracking-[-1.5px] pr-7'>
          ...
          <ul className='grid grid-cols-2 gap-4'>
            <li className='flex items-center gap-2 font-light'>
              ...
              <span className='text-[#1b1e3f] text-[17px] font-semibold'>Intervention en 30 minutes</span>
            </li>
            <li className='flex items-center gap-2 font-light'>
              <BsCheck className='w-8 h-8 text-[#f25000]' />
              <span className='text-[#1b1e3f] text-[17px] font-semibold'>Devis & conseils gratuits</span>
            </li>
            <li className='flex items-center gap-2 font-light'>
              <BsCheck className='w-8 h-8 text-[#f25000]' />
              <span className='text-[#1b1e3f] text-[17px] font-semibold'>Certifié & assuré</span>
            </li>
            <li className='flex items-center gap-2 font-light'>
              <BsCheck className='w-8 h-8 text-[#f25000]' />
              <span className='text-[#1b1e3f] text-[17px] font-semibold'>Clientèle à Nice et alentours</span>
            </li>
          </ul>
